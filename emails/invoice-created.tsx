...
export const InvoiceCreatedEmail = ({ invoiceId }: InvoiceCreatedEmailProps) => (
  <Html>
    <Head />
    <Preview>Your login code for Invoice</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Hr style={hr} />
        <Link href='http://linze.pro' style={reportLink}>
          Nicolas
        </Link>
      </Container>
    </Body>
