        ...
        <SignIn.Step name='start' className='w-full space-y-6 rounded-2xl px-4 py-10 sm:w-96 sm:px-8'>
          <header className='text-center'>
            <svg
              ...
              strokeWidth='2'
              className='lucide lucide-landmark mx-auto size-10'
              viewBox='0 0 24 24'
            >
              <path d='M3 22h18M6 18v-7M10 18v-7M14 18v-7M18 18v-7M12 2l8 5H4z'></path>
            </svg>
        ...
        <SignIn.Step name='verifications' className='w-full space-y-6 rounded-2xl px-4 py-10 sm:w-96 sm:px-8'>
          ...
          <SignIn.Strategy name='totp'>
            <header className='text-center'>
              ...
              <h1 className='mt-4 text-xl font-medium tracking-tight text-neutral-950'>Authenticator Code</h1>
            </header>
            <Clerk.GlobalError className='block text-sm text-red-600' />
            <Clerk.Field name='code'>
